...
class IzinDetailView extends StatelessWidget {
  IzinDetailView({super.key});
  final izinController = Get.find<IzinController>();
  @override
  Widget build(BuildContext context) {
    final ListIzin listIzin = Get.arguments;
    return Scaffold(
      appBar: AppBar(title: Text('Detail Izin'), centerTitle: true),
      body: Center(
        child: Container(
